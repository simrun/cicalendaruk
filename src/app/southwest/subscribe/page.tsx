      ...
      <MaxWidthContainer>
        ...
        <div className="prose mt-1 prose-blockquote:font-normal">
          ...
          <Expandable>
            ...
            <Callout type="tip">
              Once added you should be able to easily show/hide the “
              {calendarName}” calendar by toggling its checkbox in the left-hand
              sidebar. (Click{" "}
              <img
                src="/android-menu-icon-24dp.png"
                width="18"
          ...
          <Expandable>
            ...
            <Callout type="tip">
              Once added you should be able to easily show/hide the “
              {calendarName}” calendar by toggling its checkbox. On iOS this is
              in the Calendars list at the bottom of the screen. On macOS this
              is in the left sidebar.
            </Callout>
          </Expandable>
          <Expandable>
            <Expandable.Summary>
